...
func choice(_text: String, _marker: String):
    pass
...
func yarn_custom_logic(_to: String):
    pass

# called for each node name (after)
func yarn_custom_logic_after(_to: String):
    pass
...
func export_to_gdscript() -> String:
    var script := ''
